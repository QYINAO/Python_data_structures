...
#     while pos<len(alist) and not found:     # pos小于列表长度且还未找到要搜索的项
#         if alist[pos] == item:
#             found = True
#         else:
#             pos = pos + 1
...
#             found = True
#         else:
#             if alist[pos] > item:     # 升序列表匹配的终止条件(列表中的项大于要搜索的项)
#                 stop = True
#             else:
#                 pos = pos + 1
...
#     found = False
#     first = 0               # 每次查找时列表的起始
#     last = len(alist) - 1   # 每次查找时列表的终止

#     while first<=last and not found:
#         
#         midpoint = (first+last)//2   # 中间项

#         if alist[midpoint] == item:
#             found = True
#         else:
#             if item < alist[midpoint]:
#                 last = midpoint - 1       # 原列表的前半
#             else:
#                 first = midpoint + 1      # 原列表的后半
