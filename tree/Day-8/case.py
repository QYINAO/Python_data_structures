...
# r = BinaryTree('a')          # 根节点
# print(r.getRootVal())
# print(r.getLeftChild())      # 此时左孩子为None
# r.insertLeft('b')            # 插入左树
# print(r.getLeftChild())      # 此时左孩子为b
# print(r.getLeftChild().getRootVal())
# r.insertRight('c')           # 插入右树
# print(r.getRightChild())     此时右孩子为c
# print(r.getRightChild().getRootVal())
# r.getRightChild().setRootVal('hello')      # 将右节点的c改为hello
# print(r.getRightChild().getRootVal())
